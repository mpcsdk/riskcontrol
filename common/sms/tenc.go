...
type TencSmsResp struct {
	Result      []*TencSmsResult `json:"result"`
...
func NewTencSms(SecretId, SecretKey,
	Endpoint, SignMethod, Region,
	SmsSdkAppId, SignName, TemplateId string, bindingTemplateId string) *TencSms {
...
func (t *TencSms) SendBinding(destination string) (bool, string, error) {
	...
	/* 短信应用ID: 短信SdkAppId在 [短信控制台] 1400787878 */
	...
	request.TemplateId = common.StringPtr(t.bindingTemplateId)
	...
	request.PhoneNumberSet = common.StringPtrs([]string{destination})
