...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/ses v1.0.763 // indirect
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/sms v1.0.763 // indirect
